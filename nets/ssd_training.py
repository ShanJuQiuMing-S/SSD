...
class MultiboxLoss(object):
    ...
    def compute_loss(self, y_true, y_pred):
        ...
        # 获取所有的正标签的loss
        # 每一张图的pos的个数，通过y_true[:, :, -8]取出正样本 =1
        ...
        # 获取一定的负样本 ，self.neg_pos_ratio = 3.0
    ...
    def generate(self, train=True):
        while True:
            ...
            for annotation_line in lines:
                ...
                # 制作标签，编码过程
                y = self.bbox_util.assign_boxes(y)  # 编码y_true
                inputs.append(img)   # img输入SSDl里面得到预测值
                targets.append(y)  # 把y_true保存在targets
